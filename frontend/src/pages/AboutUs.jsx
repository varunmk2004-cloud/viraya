    ...
    <>
        ...
        <div className="col-lg-6 mb-4 mb-lg-0">
          <div className="animate-fade-in-up">
            ...
            >
              ...
              Viraya Productions has been at the forefront of luxury event production for over a decade. 
              We began as a small team with a big dream: to provide premium event equipment and 
              services that elevate every occasion.
            </p>
            <p 
              className="mb-0"
              style={{ 
            ...
            >
              Today, we're proud to serve clients across the globe, from intimate gatherings to 
              grand celebrations. Our commitment to excellence, attention to detail, and passion 
              for creating memorable moments has made us a trusted name in the industry.
            </p>
          </div>
        </div>
      ...
      <div className="mb-5">
        <div className="text-center mb-5">
          <h2 
            className="h2 fw-bold mb-3 gold-accent"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
          ...
          >
            Exclusive deals to make your event even more special
          </p>
        </div>

        <div className="row g-4">
          <div className="col-md-6 col-lg-4">
            <div className="card h-100 shadow-sm animate-fade-in-up position-relative overflow-hidden" 
              style={{ 
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 2px 8px rgba(26, 26, 26, 0.08)';
              }}
            >
              <div
              ...
              >
                <span className="text-dark fw-bold small">NEW</span>
              </div>
              <div className="p-4">
                <div
                  className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                ...
                >
                  <FiPercent size={35} style={{ color: '#1a1a1a' }} />
                </div>
                <h4 className="h5 fw-bold text-center mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                  First-Time Customer Discount
                </h4>
                <div className="text-center mb-3">
                  <span className="display-6 fw-bold text-primary">20% OFF</span>
                  <p className="text-muted mb-0 small">on your first rental</p>
                </div>
                <ul className="list-unstyled mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem' }}>
                  <li className="mb-2">✓ Valid for new customers only</li>
                  <li className="mb-2">✓ Minimum order ₹500</li>
                  <li className="mb-0">✓ Cannot be combined with other offers</li>
                </ul>
                <Link 
                  to="/" 
                  className="btn btn-primary w-100"
                  style={{ textTransform: 'uppercase', letterSpacing: '0.1em', fontSize: '0.875rem', textDecoration: 'none', display: 'block', textAlign: 'center' }}
                >
                  Shop Now
                </Link>
              </div>
          ...
          <div className="col-md-6 col-lg-4">
            ...
            >
              ...
              >
                <span className="text-dark fw-bold small">POPULAR</span>
              </div>
              <div className="p-4">
                <div
                  className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                ...
                >
                  <FiCalendar size={35} style={{ color: '#1a1a1a' }} />
                </div>
                <h4 className="h5 fw-bold text-center mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Seasonal Package Deal
                </h4>
                <div className="text-center mb-3">
                  <span className="display-6 fw-bold text-primary">15% OFF</span>
                  <p className="text-muted mb-0 small">on complete event packages</p>
                </div>
                <ul className="list-unstyled mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem' }}>
                  <li className="mb-2">✓ Includes equipment + setup</li>
                  <li className="mb-2">✓ Valid for 3+ day rentals</li>
                  <li className="mb-0">✓ Professional support included</li>
                </ul>
                <Link 
                  to="/" 
                  className="btn btn-primary w-100"
          ...
          <div className="col-md-6 col-lg-4">
            ...
            >
              ...
              >
                <span className="text-dark fw-bold small">LIMITED</span>
              </div>
              <div className="p-4">
                <div
                  className="rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                ...
                >
                  <FiGift size={35} style={{ color: '#1a1a1a' }} />
                </div>
                <h4 className="h5 fw-bold text-center mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Referral Bonus Program
                </h4>
                <div className="text-center mb-3">
                  <span className="display-6 fw-bold text-primary">Rs 500</span>
                  <p className="text-muted mb-0 small">credit for you & your friend</p>
                </div>
                <ul className="list-unstyled mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem' }}>
                  <li className="mb-2">✓ Refer a friend and both get Rs 100</li>
                  <li className="mb-2">✓ No expiration date</li>
                  <li className="mb-0">✓ Stackable with other offers</li>
                </ul>
                <Link 
                  to="/contact" 
                  className="btn btn-primary w-100"
          ...
          <div className="col-md-6 col-lg-4">
            ...
            >
              <div className="p-4">
                ...
                >
                  <FiTag size={35} style={{ color: '#1a1a1a' }} />
                </div>
                <h4 className="h5 fw-bold text-center mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                ...
                <div className="text-center mb-3">
                  <span className="display-6 fw-bold text-primary">15% OFF</span>
                  <p className="text-muted mb-0 small">on 5+ items rental</p>
                </div>
                <ul className="list-unstyled mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem' }}>
                  <li className="mb-2">✓ Perfect for large events</li>
                  <li className="mb-2">✓ Mix and match items</li>
                  <li className="mb-0">✓ Extended rental period available</li>
                </ul>
                <Link 
                  to="/" 
                  className="btn btn-primary w-100"
          ...
          <div className="col-md-6 col-lg-4">
            ...
            >
              <div className="p-4">
                ...
                >
                  <FiStar size={35} style={{ color: '#1a1a1a' }} />
                </div>
                <h4 className="h5 fw-bold text-center mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Premium Membership
                </h4>
                <div className="text-center mb-3">
                  <span className="display-6 fw-bold text-primary">VIP</span>
                  <p className="text-muted mb-0 small">exclusive benefits</p>
                </div>
                <ul className="list-unstyled mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem' }}>
                  <li className="mb-2">✓ Priority booking & support</li>
                  <li className="mb-2">✓ 10% off all rentals</li>
                  <li className="mb-0">✓ Free delivery & setup</li>
                </ul>
                <Link 
                  to="/contact" 
                  className="btn btn-primary w-100"
          ...
          <div className="col-md-6 col-lg-4">
            ...
            >
              <div className="p-4">
                ...
                >
                  <FiTrendingUp size={35} style={{ color: '#1a1a1a' }} />
                </div>
                <h4 className="h5 fw-bold text-center mb-3" style={{ fontFamily: "'Playfair Display', serif" }}>
                  Early Bird Special
                </h4>
                <div className="text-center mb-3">
                  <span className="display-6 fw-bold text-primary">30% OFF</span>
                  <p className="text-muted mb-0 small">book 60+ days in advance</p>
                </div>
                <ul className="list-unstyled mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '1.1rem' }}>
                  <li className="mb-2">✓ Best rates for planning ahead</li>
                  <li className="mb-2">✓ Guaranteed availability</li>
                  <li className="mb-0">✓ Flexible cancellation policy</li>
                </ul>
                <Link 
                  to="/" 
                  className="btn btn-primary w-100"
